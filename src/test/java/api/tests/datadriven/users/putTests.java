...
public class putTests {
	...
	public void PutUserTestMethod1(String UserId, String UserName, String FIrstName, String LastName, String Email,
		...
		UserEndPoints2.createUser(userpayload); // Pre-requisite
	...
	@Test(description = "Validate that API should return API status code as 200", dataProvider = "alldata", dataProviderClass = DataProviders.class, priority = 1)
	...
	@Test(description = "Validate that API should return a response payload ie. Non-empty response body and response header", dataProvider = "alldata", dataProviderClass = DataProviders.class, priority = 1)
	...
	@Test(description = "Validate that API should return response of type = JSON", dataProvider = "alldata", dataProviderClass = DataProviders.class, priority = 1)
	...
	@Test(description = "Validate that API should should adhere to Response structure as per data model mentioned in API Spec or API Doc.- JSON SCHEMA VALIDATION", dataProvider = "alldata", dataProviderClass = DataProviders.class, priority = 1)
	...
	@Test(description = "Valdiate that API should return response body with details of all existing users", dataProvider = "alldata", dataProviderClass = DataProviders.class, priority = 1)
	...
	@Test(description = "Valdiate that API should return response headers as per the spec", dataProvider = "alldata", dataProviderClass = DataProviders.class, priority = 1)
